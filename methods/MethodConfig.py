...
class MethodConfig:
    ...
    nact: int    = 200  #100      #amount of steps is tuned so autocorr is small enough, needed for determining the correct slicing behaviour
    npool: int   = 18
    maxmcmc: int = 20000   #needed for MCMC sampeling, not 